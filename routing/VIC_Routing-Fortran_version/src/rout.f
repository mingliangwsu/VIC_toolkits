...
c     no changes after here
      ...
      CHARACTER*21 NAME
      CHARACTER*6  NAME5
      CHARACTER*256 FILE_INPUT, FILENAME
      CHARACTER*256 INPATH, OUTPATH
...
c     calculate number of days & months in simulation
      ...
      IF(NDAY.GT.DAYS) THEN
         PRINT*, 'IN ROUT.F RESET DAYS TO ', NDAY, ' increase NYR(', NYR, ') size in the source code!!!'
         STOP
      ENDIF
